...
# Private Routes
export PRIVATE_ROUTES="/api/tictactoe/games/*"
...
# Get token user Endpoint
export GET_USER_BY_TOKEN_ENDPOINT="http://localhost:8082/api/identitysvc/users"
env | grep '^GET_USER_BY_TOKEN_ENDPOINT='